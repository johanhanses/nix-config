...
terminal/CLI/tmux-worktree workflow, **Catppuccin** (Latte/Mocha) with automatic
...
Terminal.app carries the palette (Latte/Mocha profiles); most CLI tools follow the
